...
const AboutUs = function () {
  return (
    <Fragment className="font-pop">
      <div className="grid grid-cols-2 ml-40 mt-20 gap-5 justify-content-center">
        <div className="">
          <p className="text-4xl font-bold ">
            <span className="h-3 w-3 bg-gray-500 rounded-full inline-block mr-3 mb-2"></span>
            I'm Daillan Leigh Franco, a <br />
            future Front End Developer
          </p>

          <p className="mt-5 text-2xl indent-8">
        ...
        <div>
          <h2 className="underline text-3xl font-bold mb-2">What I like?</h2>
          ...
          <br />
          <h2 className="underline text-3xl font-bold mb-2">
