...
const Faq = function () {
  return (
    <Fragment className="font-pop">
      <h1 className="text-center mt-8 lg:mt-16 text-gray-800 text-2xl lg:text-4xl font-bold">
        Frequently Asked Questions (FAQ)
      </h1>

      <div className="mt-8 lg:mt-16 grid grid-cols-2 items-center mr-40">
        ...
        <span className="answer-logo justify-self-end">A.</span>
        <p className="answer justify-self-start">
          Windows is the operating system that I use.
        </p>
      </div>
    </Fragment>
  );
